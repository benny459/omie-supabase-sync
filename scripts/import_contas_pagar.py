...
def importar_empresa(sigla: str):
    ...
    if not items:
        ...
        update_sync_state(f"contas_pagar_{sigla}", sigla, 0, modo="FULL")
        return 0
...
def main():
    print("=" * 60)
    print("  IMPORT CONTAS A PAGAR  (Omie -> Supabase)")
    print("=" * 60)
